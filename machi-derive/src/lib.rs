...
/// A macro that allows you to implement the `machi::embedding::Embed` trait by deriving it.
...
/// A procedural macro that transforms a function into a `machi::tool::Tool` that can be used with a `machi::agent::Agent`.
///
/// # Examples
///
/// Basic usage:
...
/// fn calculator(x: i32, y: i32, operation: String) -> Result<i32, machi::tool::ToolError> {
...
///     )
/// )]
/// fn string_processor(text: String, operation: String) -> Result<String, machi::tool::ToolError> {
///     match operation.as_str() {
...
pub fn machi_tool(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        impl machi::tool::Tool for #struct_name {
            ...
            async fn definition(&self, _prompt: String) -> machi::completion::ToolDefinition {
